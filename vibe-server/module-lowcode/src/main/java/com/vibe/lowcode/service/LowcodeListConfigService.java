 ...
 * @author vibe
 */
public interface LowcodeListConfigService {

    /** 分页查询（keyword 模糊匹配 configCode / configName） */
    PageResult<LowcodeListConfigVO> page(PageQuery query, String keyword);

    /** 获取详情 */
    LowcodeListConfigVO getById(Long id);

    /** 创建配置 */
    Long create(LowcodeListConfigDTO dto);

    /** 更新配置 */
    void update(Long id, LowcodeListConfigDTO dto);
    ...
    Long importJson(LowcodeListConfigDTO dto);
