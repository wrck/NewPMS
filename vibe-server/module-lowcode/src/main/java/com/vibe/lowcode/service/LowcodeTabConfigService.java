 ...
 * @author vibe
 */
public interface LowcodeTabConfigService {

    /** 分页查询（keyword 模糊匹配 configCode / configName） */
    PageResult<LowcodeTabConfigVO> page(PageQuery query, String keyword);

    /** 获取详情 */
    LowcodeTabConfigVO getById(Long id);

    /** 创建配置 */
    Long create(LowcodeTabConfigDTO dto);

    /** 更新配置 */
    void update(Long id, LowcodeTabConfigDTO dto);
    ...
    Long importJson(LowcodeTabConfigDTO dto);
